...
- Test your systems on the latest dataset versions. Authors are encouraged to use the recently released UD 2.13 release and PARSEME 1.3 release to test their systems.

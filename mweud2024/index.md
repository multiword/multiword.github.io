...
<table class="program">
    ...
    <tr>
        <td></td>
        <td>
            <i>MultiMWE: Building a Multi-lingual Multi-Word Expression (MWE) Parallel Corpora</i><br>
    ...
    <tr>
        <td></td>
        <td>
            <i>A demonstration of MWE-Finder and MWE-Annotator</i><br>
    ...
    <tr>
        <td></td>
        <td>
            <i>Is Less More? Quality, Quantity and Context in Idiom Processing with Natural Language Models</i><br>
    ...
    <tr>
        <td></td>
        <td>
            <i>Annotating Compositionality Scores for Irish Noun Compounds is Hard Work</i><br>
    ...
    <tr>
        ...
        <td>
            ...
            Qi Yu, Fabian Schlotterbeck, Hening Wang, Naomi Reichmann, Britta Stolterfoht, Regine Eckardt and Miriam Butt<br>
    ...
    <tr>
        <td></td>
        <td>
            <i>AlphaMWE-Arabic: Arabic Edition of Multilingual Parallel Corpora with Multiword Expression Annotations</i><br>
    ...
    <tr>
        <td></td>
        <td>
            <i>MaiBaam: A Multi-Dialectal Bavarian Universal Dependency Treebank</i><br>
    ...
    <tr>
        <td></td>
        <td>
            <i>Redefining Syntactic and Morphological Tasks for Typologically Diverse Languages</i><br>
    ...
    <tr>
        <td></td>
        <td>
            <i>UCxn: Typologically Informed Annotation of Constructions Atop Universal Dependencies</i><br>
    ...
    <tr>
        <td></td>
        <td>
            <i>Sparse Logistic Regression with High-order Features for Automatic Grammar Rule Extraction from Treebanks</i><br>
    ...
    <tr>
        <td></td>
        <td>
            <i>Joint Annotation of Morphology and Syntax in Dependency Treebanks</i><br>
